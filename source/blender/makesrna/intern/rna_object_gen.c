...
{
	Object *data = (Object *)(ptr->data);
	data->sf = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupsta = CLAMPIS(value, -500000, 500000);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupend = CLAMPIS(value, -500000, 500000);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupon = CLAMPIS(value, 0, 500000);
}
...
{
	Object *data = (Object *)(ptr->data);
	data->dupoff = CLAMPIS(value, 0, 500000);
}
...
FloatPropertyRNA rna_Object_slow_parent_offset = {
	...
	Object_slow_parent_offset_get, Object_slow_parent_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
