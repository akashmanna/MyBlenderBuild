...
/* Point Lamp */
static EnumPropertyItem rna_PointLamp_falloff_type_items[7] = {
...
EnumPropertyRNA rna_PointLamp_falloff_type = {
	...
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	PointLamp_falloff_type_get, PointLamp_falloff_type_set, NULL, NULL, NULL, NULL, rna_PointLamp_falloff_type_items, 6, 0
};
...
FloatPropertyRNA rna_PointLamp_constant_coefficient = {
	...
	-1, "constant_coefficient", 8195, "Constant Coefficient",
	"Constant distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_const), 4, NULL},
...
FloatPropertyRNA rna_PointLamp_linear_coefficient = {
	...
	-1, "linear_coefficient", 8195, "Linear Coefficient",
	"Linear distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_lin), 4, NULL},
...
FloatPropertyRNA rna_PointLamp_quadratic_coefficient = {
	{(PropertyRNA *)&rna_PointLamp_use_shadow, (PropertyRNA *)&rna_PointLamp_linear_coefficient,
	-1, "quadratic_coefficient", 8195, "Quadratic Coefficient",
	"Quadratic distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	offsetof(Lamp, coeff_quad), 4, NULL},
...
BoolPropertyRNA rna_PointLamp_use_shadow = {
	{(PropertyRNA *)&rna_PointLamp_shadow_method, (PropertyRNA *)&rna_PointLamp_quadratic_coefficient,
...
/* Spot Lamp */
static EnumPropertyItem rna_SpotLamp_falloff_type_items[7] = {
	{0, "CONSTANT", 0, "Constant", ""},
	{1, "INVERSE_LINEAR", 0, "Inverse Linear", ""},
	{2, "INVERSE_SQUARE", 0, "Inverse Square", ""},
	{5, "INVERSE_COEFFICIENTS", 0, "Inverse Coefficients", ""},
...
EnumPropertyRNA rna_SpotLamp_falloff_type = {
	...
	rna_Lamp_update, 0, NULL, NULL,
	0, -1, NULL},
	SpotLamp_falloff_type_get, SpotLamp_falloff_type_set, NULL, NULL, NULL, NULL, rna_SpotLamp_falloff_type_items, 6, 0
};
...
FloatPropertyRNA rna_SpotLamp_quadratic_coefficient = {
	{(PropertyRNA *)&rna_SpotLamp_use_shadow, (PropertyRNA *)&rna_SpotLamp_linear_coefficient,
	-1, "quadratic_coefficient", 8195, "Quadratic Coefficient",
	"Quadratic distance attenuation coefficient",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_SpotLamp_use_shadow = {
	{(PropertyRNA *)&rna_SpotLamp_shadow_method, (PropertyRNA *)&rna_SpotLamp_quadratic_coefficient,
	-1, "use_shadow", 3, "use_shadow",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
