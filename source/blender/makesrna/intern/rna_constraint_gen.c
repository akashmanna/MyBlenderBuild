...
{
	bFollowPathConstraint *data = (bFollowPathConstraint *)(((bConstraint *)ptr->data)->data);
	data->offset = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	bActionConstraint *data = (bActionConstraint *)(((bConstraint *)ptr->data)->data);
	data->start = CLAMPIS(value, -500000, 500000);
}
...
{
	bActionConstraint *data = (bActionConstraint *)(((bConstraint *)ptr->data)->data);
	data->end = CLAMPIS(value, -500000, 500000);
}
...
FloatPropertyRNA rna_FollowPathConstraint_offset = {
	...
	FollowPathConstraint_offset_get, FollowPathConstraint_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
