...
int BoolProperty_is_array_get(PointerRNA *ptr)
{
...
int IntProperty_is_array_get(PointerRNA *ptr)
{
	return rna_NumberProperty_is_array_get(ptr);
}
...
int FloatProperty_is_array_get(PointerRNA *ptr)
{
	return rna_NumberProperty_is_array_get(ptr);
}
...
static EnumPropertyItem rna_Property_icon_items[555] = {
	{0, "NONE", 0, "NONE", ""},
...
EnumPropertyRNA rna_Property_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Property_icon_get, NULL, NULL, NULL, NULL, NULL, rna_Property_icon_items, 554, 0
};
...
IntPropertyRNA rna_BoolProperty_array_length = {
	{(PropertyRNA *)&rna_BoolProperty_is_array, (PropertyRNA *)&rna_BoolProperty_default_array,
...
BoolPropertyRNA rna_BoolProperty_is_array = {
	{NULL, (PropertyRNA *)&rna_BoolProperty_array_length,
	-1, "is_array", 2, "Is Array",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_IntProperty_array_length = {
	{(PropertyRNA *)&rna_IntProperty_is_array, (PropertyRNA *)&rna_IntProperty_default_array,
	-1, "array_length", 2, "Array Length",
	"Maximum length of the array, 0 means unlimited",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_IntProperty_is_array = {
	{(PropertyRNA *)&rna_IntProperty_hard_min, (PropertyRNA *)&rna_IntProperty_array_length,
	-1, "is_array", 2, "Is Array",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_FloatProperty_array_length = {
	{(PropertyRNA *)&rna_FloatProperty_is_array, (PropertyRNA *)&rna_FloatProperty_default_array,
	-1, "array_length", 2, "Array Length",
	"Maximum length of the array, 0 means unlimited",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_FloatProperty_is_array = {
	{(PropertyRNA *)&rna_FloatProperty_hard_min, (PropertyRNA *)&rna_FloatProperty_array_length,
	-1, "is_array", 2, "Is Array",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
static EnumPropertyItem rna_EnumPropertyItem_icon_items[555] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_EnumPropertyItem_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	EnumPropertyItem_icon_get, NULL, NULL, NULL, NULL, NULL, rna_EnumPropertyItem_icon_items, 554, 0
};
