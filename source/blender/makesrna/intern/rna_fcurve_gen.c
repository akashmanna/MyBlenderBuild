...
int DriverVariable_is_name_valid_get(PointerRNA *ptr)
{
	DriverVar *data = (DriverVar *)(ptr->data);
	return !(((data->flag) & 2) != 0);
}
...
{
	ChannelDriver *data = (ChannelDriver *)(ptr->data);
	BLI_strncpy_utf8(value, data->expression, 512);
}
...
{
	ChannelDriver *data = (ChannelDriver *)(ptr->data);
	BLI_strncpy_utf8(data->expression, value, 512);
}
...
struct BezTriple *FCurveKeyframePoints_insert(struct FCurve *_self, float frame, float value, int keyframe_type, int options)
{
	return rna_FKeyframe_points_insert(_self, frame, value, keyframe_type, options);
}
...
void FCurveKeyframePoints_insert_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	keyframe = rna_FKeyframe_points_insert(_self, frame, value, keyframe_type, options);
...
IntPropertyRNA rna_FCurve_convert_to_samples_start = {
	...
	-500000, 500000, -500000, 500000, 1, 0, NULL
};
...
FloatPropertyRNA rna_FCurveKeyframePoints_insert_value = {
	{(PropertyRNA *)&rna_FCurveKeyframePoints_insert_keyframe_type, (PropertyRNA *)&rna_FCurveKeyframePoints_insert_frame,
	-1, "value", 7, "",
...
static EnumPropertyItem rna_FCurveKeyframePoints_insert_keyframe_type_items[5] = {
	{0, "KEYFRAME", 846, "Keyframe", "Normal keyframe - e.g. for key poses"},
	{2, "BREAKDOWN", 847, "Breakdown", "A breakdown pose - e.g. for transitions between key poses"},
	{1, "EXTREME", 848, "Extreme", "An \'extreme\' pose, or some other purpose as needed"},
	{3, "JITTER", 849, "Jitter", "A filler or baked keyframe for keying on ones, or some other purpose as needed"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_FCurveKeyframePoints_insert_keyframe_type = {
	{(PropertyRNA *)&rna_FCurveKeyframePoints_insert_options, (PropertyRNA *)&rna_FCurveKeyframePoints_insert_value,
	-1, "keyframe_type", 3, "",
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_FCurveKeyframePoints_insert_keyframe_type_items, 4, 0
};
...
EnumPropertyRNA rna_FCurveKeyframePoints_insert_options = {
	{(PropertyRNA *)&rna_FCurveKeyframePoints_insert_keyframe, (PropertyRNA *)&rna_FCurveKeyframePoints_insert_keyframe_type,
	-1, "options", 2097155, "",
	"Keyframe options",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_DriverVariable_is_name_valid = {
	...
	-1, "is_name_valid", 2, "Is Name Valid",
...
StringPropertyRNA rna_Driver_expression = {
	...
	0, -1, NULL},
	Driver_expression_get, Driver_expression_length, Driver_expression_set, NULL, NULL, NULL, 512, ""
};
