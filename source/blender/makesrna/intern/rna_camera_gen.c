...
int CameraStereoData_use_spherical_stereo_get(PointerRNA *ptr)
{
	CameraStereoSettings *data = (CameraStereoSettings *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void CameraStereoData_use_spherical_stereo_set(PointerRNA *ptr, int value)
{
	CameraStereoSettings *data = (CameraStereoSettings *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
BoolPropertyRNA rna_CameraStereoData_use_spherical_stereo = {
	{NULL, (PropertyRNA *)&rna_CameraStereoData_convergence_distance,
...
StructRNA RNA_CameraStereoData = {
	...
	NULL,
	{(PropertyRNA *)&rna_CameraStereoData_rna_properties, (PropertyRNA *)&rna_CameraStereoData_use_spherical_stereo}},
