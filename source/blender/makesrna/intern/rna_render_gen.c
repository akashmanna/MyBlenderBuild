...
int RenderEngine_bl_use_spherical_stereo_get(PointerRNA *ptr)
{
	RenderEngine *data = (RenderEngine *)(ptr->data);
	return (((data->type->flag) & 512) != 0);
}

void RenderEngine_bl_use_spherical_stereo_set(PointerRNA *ptr, int value)
{
	RenderEngine *data = (RenderEngine *)(ptr->data);
...
float RenderEngine_camera_shift_x(struct RenderEngine *_self, struct Object *camera, int use_spherical_stereo)
{
...
void RenderEngine_camera_shift_x_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	_data += 8;
	use_spherical_stereo = *((int *)_data);
	_data += 4;
	_retdata = _data;
...
void RenderEngine_camera_model_matrix(struct RenderEngine *_self, struct Object *camera, int use_spherical_stereo, float r_model_matrix[16])
{
...
int RenderEngine_use_spherical_stereo(struct RenderEngine *_self, struct Object *camera)
{
...
void RenderEngine_use_spherical_stereo_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	*((int *)_retdata) = use_spherical_stereo;
}
...
float RE_engine_get_camera_shift_x(struct RenderEngine *_self, struct Object *camera, int use_spherical_stereo);
void RE_engine_get_camera_model_matrix(struct RenderEngine *_self, struct Object *camera, int use_spherical_stereo, float r_model_matrix[16]);
int RE_engine_get_spherical_stereo(struct RenderEngine *_self, struct Object *camera);
...
BoolPropertyRNA rna_RenderEngine_bl_use_spherical_stereo = {
	...
	-1, "bl_use_spherical_stereo", 51, "bl_use_spherical_stereo",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FunctionRNA rna_RenderEngine_test_break_func = {
	{(FunctionRNA *)&rna_RenderEngine_active_view_get_func, (FunctionRNA *)&rna_RenderEngine_end_result_func,
	NULL,
...
BoolPropertyRNA rna_RenderEngine_camera_shift_x_use_spherical_stereo = {
	...
	-1, "use_spherical_stereo", 3, "Spherical Stereo",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_RenderEngine_use_spherical_stereo_use_spherical_stereo = {
	...
	-1, "use_spherical_stereo", 11, "Spherical Stereo",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
