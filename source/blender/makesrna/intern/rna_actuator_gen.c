...
{
	bRandomActuator *data = (bRandomActuator *)(((bActuator *)ptr->data)->data);
	data->seed = CLAMPIS(value, 0, 500000);
}
...
FloatPropertyRNA rna_ActionActuator_frame_start = {
	...
	ActionActuator_frame_start_get, ActionActuator_frame_start_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 500000.0f, -FLT_MAX, FLT_MAX, 100.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_ActionActuator_frame_end = {
	...
	ActionActuator_frame_end_get, ActionActuator_frame_end_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 500000.0f, -FLT_MAX, FLT_MAX, 100.0f, 2, 0.0f, NULL
};
