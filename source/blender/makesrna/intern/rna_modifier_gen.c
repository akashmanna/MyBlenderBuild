...
{
	BuildModifierData *data = (BuildModifierData *)(ptr->data);
	data->start = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	BuildModifierData *data = (BuildModifierData *)(ptr->data);
	data->length = CLAMPIS(value, 1.0f, 500000.0f);
}
...
{
	BuildModifierData *data = (BuildModifierData *)(ptr->data);
	data->seed = CLAMPIS(value, 1, 500000);
}
...
{
	WaveModifierData *data = (WaveModifierData *)(ptr->data);
	data->timeoffs = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	WaveModifierData *data = (WaveModifierData *)(ptr->data);
	data->lifetime = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	WaveModifierData *data = (WaveModifierData *)(ptr->data);
	data->damp = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
int ShrinkwrapModifier_invert_vertex_group_get(PointerRNA *ptr)
{
	ShrinkwrapModifierData *data = (ShrinkwrapModifierData *)(ptr->data);
	return (((data->shrinkOpts) & 64) != 0);
}

void ShrinkwrapModifier_invert_vertex_group_set(PointerRNA *ptr, int value)
{
	ShrinkwrapModifierData *data = (ShrinkwrapModifierData *)(ptr->data);
...
int SimpleDeformModifier_invert_vertex_group_get(PointerRNA *ptr)
{
	SimpleDeformModifierData *data = (SimpleDeformModifierData *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void SimpleDeformModifier_invert_vertex_group_set(PointerRNA *ptr, int value)
{
	SimpleDeformModifierData *data = (SimpleDeformModifierData *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
{
	MeshCacheModifierData *data = (MeshCacheModifierData *)(ptr->data);
	data->frame_start = CLAMPIS(value, -500000.0f, 500000.0f);
}
...
{
	MeshCacheModifierData *data = (MeshCacheModifierData *)(ptr->data);
	data->eval_frame = CLAMPIS(value, 0.0f, 500000.0f);
}
...
FloatPropertyRNA rna_BuildModifier_frame_start = {
	...
	BuildModifier_frame_start_get, BuildModifier_frame_start_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_BuildModifier_frame_duration = {
	...
	BuildModifier_frame_duration_get, BuildModifier_frame_duration_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.0f, 500000.0f, 1.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_WaveModifier_time_offset = {
	...
	WaveModifier_time_offset_get, WaveModifier_time_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_WaveModifier_lifetime = {
	...
	WaveModifier_lifetime_get, WaveModifier_lifetime_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_WaveModifier_damping_time = {
	...
	WaveModifier_damping_time_get, WaveModifier_damping_time_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_SimpleDeformModifier_lock_y = {
	{(PropertyRNA *)&rna_SimpleDeformModifier_invert_vertex_group, (PropertyRNA *)&rna_SimpleDeformModifier_lock_x,
...
BoolPropertyRNA rna_SimpleDeformModifier_invert_vertex_group = {
	{NULL, (PropertyRNA *)&rna_SimpleDeformModifier_lock_y,
	-1, "invert_vertex_group", 3, "Invert",
	"Invert vertex group influence",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_MeshCacheModifier_frame_start = {
	...
	MeshCacheModifier_frame_start_get, MeshCacheModifier_frame_start_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -500000.0f, 500000.0f, -500000.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_MeshCacheModifier_eval_frame = {
	...
	MeshCacheModifier_eval_frame_get, MeshCacheModifier_eval_frame_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 500000.0f, 0.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
