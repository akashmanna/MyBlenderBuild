...
int DopeSheet_use_multi_word_filter_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void DopeSheet_use_multi_word_filter_set(PointerRNA *ptr, int value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
BoolPropertyRNA rna_DopeSheet_use_multi_word_filter = {
	...
	-1, "use_multi_word_filter", 3, "Multi-Word Fuzzy Filter",
