...
{
	Key *data = (Key *)(ptr->data);
	data->ctime = CLAMPIS(value, 0.0f, 500000.0f);
}
...
FloatPropertyRNA rna_Key_eval_time = {
	...
	Key_eval_time_get, Key_eval_time_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 500000.0f, 0.0f, 500000.0f, 10.0f, 3, 0.0f, NULL
};
